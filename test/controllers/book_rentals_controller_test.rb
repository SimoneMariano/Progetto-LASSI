...
class BookRentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_rental" do
    assert_difference("BookRental.count") do
      post book_rentals_url, params: { book_rental: { book: @book_rental.book, end: @book_rental.end, start: @book_rental.start, user: @book_rental.user } }
    end
  ...
  test "should update book_rental" do
    patch book_rental_url(@book_rental), params: { book_rental: { book: @book_rental.book, end: @book_rental.end, start: @book_rental.start, user: @book_rental.user } }
